package com.example.jarisandstrom.realmexample.activity;
...
import com.example.jarisandstrom.realmexample.R;
import com.example.jarisandstrom.realmexample.adapters.BooksAdapter;
import com.example.jarisandstrom.realmexample.adapters.RealmBooksAdapter;
import com.example.jarisandstrom.realmexample.app.Prefs;
                ...
                builder.setView(content)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                book.setId(RealmController.getInstance().getBooks().size());
